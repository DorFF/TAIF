...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HorisontalScrollSnaper : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        ...
        void Update()
        {
            ...
            if (CurrentTarget == steps.Length - 1)
            {
                if (Forward != null)
            ...
            numberSlide.text = number.ToString();
        }
        #region Interfaces
