...
[AddComponentMenu("Image Effects/Bloom and Glow/Natural Bloom and Lens Dirt")]
public class NaturalBloom : MonoBehaviour
{
	[Range(0.0f, 0.4f)]
	...
	void Start() 
	{
        ...
        if(!shader)
            shader = Shader.Find("Hidden/Natural Bloom and Lens Dirt");
